    ...
    <>
      <div className="mx-8 xl:mx-[80px] pt-8 items-center">
        <div className="items-center mb-4" style={{textAlign:"center"}}>
          ...
          <p>
            <small>
              The data visualization aims to shed light on the correlation between child mortality 
              rates under the age of five and the economic growth of each country.<br></br>
              <b>Scroll or pinch to zoom in and out in map. Drag map to
              pan. Hover and click a country to view details.</b>
            </small>
          </p>
        </div>
        ...
        <p className="mt-4" style={{textAlign:"center"}}>
          <small>
            13519011 Jesica - 13519063 Melita - 13519101 Stefanus - 13519213 Clarisa Natalia Edelin <br></br>
            Data source :  <a href="https://ourworldindata.org/explorers/global-health?tab=table" style={{ color: "blue" }}>https://ourworldindata.org/explorers/global-health?tab=table</a> and  <a href="https://data.worldbank.org/indicator/NY.GDP.MKTP.CD?end=2021&start=1960&view=chart&year=1990" style={{ color: "blue" }}>https://data.worldbank.org/indicator/NY.GDP.MKTP.CD?end=2021&start=1960&view=chart&year=1990</a>
          </small>
        </p>
      </div>
    </>
